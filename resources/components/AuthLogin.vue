...
useHead({
  title: 'Login - Bench Review',
  meta: [
    { name: 'description', content: 'Sign in to your account to access detailed judge reviews, ratings, and insights from legal professionals.' },
  ],
  link: [
  ...
  <div class="h-screen">
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 border-gray-300 rounded text-gray-600 focus:ring-gray-600">
              <label for="remember-me" class="ml-3 block text-sm text-gray-900 leading-6">Remember me</label>
            </div>

            <div class="text-sm leading-6">
              <a href="#" class="text-gray-600 font-semibold hover:text-gray-500">Forgot password?</a>
            </div>
          </div>
      ...
      <p class="mt-10 text-center text-sm/6 text-gray-500">
        ...
        <router-link to="/register" class="font-semibold text-gray-600 hover:text-gray-500">Sign up</router-link>
      </p>
    </div>
  </div>
